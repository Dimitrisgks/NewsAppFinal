...
import com.example.hell.newsapp.databinding.ActivityMainBinding;

import java.util.ArrayList;
import java.util.List;

public class NewsAppActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<List<News>> {
    private static final String NEWS_REQUEST_URL = "http://content.guardianapis.com/search?q=technology&api-key=test&page-size=20&show-tags=contributor";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.emptyView.setText(getResources().getText(R.string.NoNews));
        ...
        binding.newsListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long l) {
                ...
                if (currentNews.getWebUrl() == null || TextUtils.isEmpty(currentNews.getWebUrl())) {
                    Toast.makeText(NewsAppActivity.this, NewsAppActivity.this.getResources().getString(R.string.NoLink), Toast.LENGTH_SHORT).show();
                } else {
        ...
        if (networkInfo != null && networkInfo.isConnected()) {
            ...
            View loadingIndicator = findViewById(R.id.Refresh);
    ...
    public void onLoadFinished(Loader<List<News>> loader, List<News> data) {
        ...
        binding.emptyView.setText(R.string.NoNews);
